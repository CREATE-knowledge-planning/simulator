...
define('conic/conic-sensor-graphics',['require','Cesium/Core/defaultValue','Cesium/Core/defined','Cesium/Core/DeveloperError','Cesium/Core/Event','Cesium/DataSources/createMaterialPropertyDescriptor','Cesium/DataSources/createPropertyDescriptor'],function(require) {
	'use strict';
...
define('custom/custom-pattern-sensor-graphics',['require','Cesium/Core/defaultValue','Cesium/Core/defined','Cesium/Core/DeveloperError','Cesium/Core/Event','Cesium/DataSources/createMaterialPropertyDescriptor','Cesium/DataSources/createPropertyDescriptor'],function(require) {
	'use strict';
...
define('rectangular/rectangular-sensor-graphics',['require','Cesium/Core/defaultValue','Cesium/Core/defined','Cesium/Core/DeveloperError','Cesium/Core/Event','Cesium/DataSources/createPropertyDescriptor'],function(require) {
	'use strict';
...
define('rectangular/rectangular-pyramid-sensor-volume',['require','Cesium/Core/clone','Cesium/Core/defaultValue','Cesium/Core/defined','Cesium/Core/destroyObject','Cesium/Core/DeveloperError','Cesium/Core/Math','Cesium/Core/Spherical','../custom/custom-sensor-volume'],function(require) {
	'use strict';
